 ...
 * 2、require_once 'OpenSDK/RenRen/renren.php';
...
class Model_Renren extends OAuth_Interface
{
     ...
     * @return string
     */
    public static function getAuthorizeURL( $url, $response_type, $state, 
    	$display='default', $arrExtra=array() )
    {
        $params = array();
        ...
        $params = array_merge($params, $arrExtra);
