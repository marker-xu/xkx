...
class Model_Sina extends OAuth_Interface
{
     ...
     */
    const REFRESH_TOKEN = 'sina_refresh_token';

    /**
     * 存储expires_in的sieesion key
     */
    const EXPIRES_IN = 'sina_expires_in';
    ...
    public static function getAccessToken( $type , $keys )
    {
        ...
        {
            JKit::$log->warn(__FUNCTION__."get access token failed ,ret-",$token);
            return false;
