...
class Model_Tqq extends OAuth_Interface
{
     ...
     */
    const OAUTH_TOKEN = 'tqq_oauth_token';
    /**
     * 存储oauth_token_secret的session key
     */
    const OAUTH_TOKEN_SECRET = 'tqq_oauth_token_secret';
    /**
     * 存储access_token的session key
     */
    const ACCESS_TOKEN = 'tqq_access_token';

    /**
     * 存储oauth_name的Session key
     */
    const OAUTH_NAME = 'tqq_oauth_name';

    /**
     * 存储oauth_openid的Session key
     * 腾讯业务通用，与OpenSDK_Tencent_SNS::OAUTH_OPENID 值相同
     */
    const OAUTH_OPENID = 'tqq_oauth_openid';

    /**
     * 存储oauth_openkey的Session key
     * 与OPENID配对使用
     */
    const OAUTH_OPENKEY = 'tqq_oauth_openkey';
    ...
    public static function getRequestToken($callback='null')
    {
        ...
        {
            JKit::$log->warn(__FUNCTION__."get Request token failed ,ret-",$rt);
            return false;
        }
    }
    ...
    public static function getAccessToken( $oauth_verifier = false )
    {
        ...
        JKit::$log->warn(__FUNCTION__."getAccessToken failed ,ret-",$rt);
        return false;
    }
